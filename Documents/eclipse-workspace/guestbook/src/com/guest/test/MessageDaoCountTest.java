...
/**
 * Servlet implementation class MessageDaoCountTest
 */
@WebServlet("/MessageDaoCountTest")
public class MessageDaoCountTest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MessageDaoCountTest() {
        super();
