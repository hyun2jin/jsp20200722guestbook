...
/**
 * Servlet implementation class GetMessageListServiceTest
 */
@WebServlet("/GetMessageListServiceTest")
public class GetMessageListServiceTest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetMessageListServiceTest() {
        super();
